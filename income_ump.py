...
2. Perbandingan **rata-rata pendapatan pekerja informal** dengan **UMP DI Yogyakarta** tidak terlalu jauh berbeda, dengan rata-rata selisih sebesar **Rp566.732** per kapita sebulan. Kemungkinan buruh yang mendapatkan upah sebesar UMP DI Yogyakarta juga mengalami kesenjangan pendapatan yang serupa dengan pekerja informal, namun harus dilakukan analisa lanjutan.
